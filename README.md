...
- **Tests.** 92 pytest tests covering auth, CRUD, scenarios, calculator math, performance metrics, risk metrics, rebalancing, dashboard summary + history + risk, alerts, transactions, planning/fire, PWA artefacts, live-refresh FX normalisation.
