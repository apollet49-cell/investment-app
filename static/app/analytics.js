// PostHog product analytics. Loaded lazily from /config/public after
// bootApp. If POSTHOG_API_KEY isn't set on the server, the SDK never
// loads and track() becomes a no-op so dev/test runs aren't tracked.
import { state } from "/static/app.js";
